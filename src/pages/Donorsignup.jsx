          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '24px' }}>
              <input
                ...
                type="checkbox"
                required
                style={{ width: '16px', height: '16px', marginTop: '4px', color: '#dc2626', borderRadius: '4px', border: '1px solid var(--surface-border)', accentColor: '#dc2626' }}
              />
              <label htmlFor="terms" style={{ marginLeft: '8px', fontSize: '14px', color: 'var(--text-primary)' }}>
                I agree to the{' '}
                <button type="button" style={{ color: '#dc2626', textDecoration: 'none', background: 'none', border: 'none', padding: 0, cursor: 'pointer' }}>Terms and Conditions</button>
                {' '}and{' '}
                <button type="button" style={{ color: '#dc2626', textDecoration: 'none', background: 'none', border: 'none', padding: 0, cursor: 'pointer' }}>Privacy Policy</button>
              </label>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginTop: '8px' }}>
                Need blood instead?{' '}
                <Link to="/receiver-signup" style={{ color: '#3b82f6', fontWeight: 600, textDecoration: 'none' }}>
                  Sign up as Receiver
                </Link>
              </p>
            </div>
